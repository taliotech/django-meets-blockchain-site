          ...
          <TitleInner>
            <TitleInnerContainer>
              <HomepageLink to="/" href="/" onClick={onCloseNavMenu}>
                <Logo src={require('assets/images/logo-talio.png')} alt="Talio" />
              </HomepageLink>
              <MediaQuery.ServerRender predicted="desktop">
                <MediaQuery.Matcher
                  mobile={<Subtitle>Django + Blockchain</Subtitle>}
                  tablet={<Subtitle>Django + Blockchain</Subtitle>}
                  desktop={<Subtitle>Django Meets Blockchain</Subtitle>}
                />
